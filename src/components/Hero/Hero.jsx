  ...
  return (
    <div className="dark:bg-black dark:text-white duration-300 relative overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Book reliable and affordable cab services in Jamnagar. 24/7 taxi service with professional drivers."
        />
        <meta
          name="keywords"
          content="Jamnagar Cab, Cab Service in Jamnagar, Taxi in Jamnagar, Outstation Taxi Jamnagar, Airport Cab Jamnagar"
        />
